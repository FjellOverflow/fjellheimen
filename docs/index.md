...
features:
  - title: "IaC with docker"
    ...
    details: "Quickly add, spin up and manage containerized apps. 100% reproducable."
    link: /applications/add-new-app
  - title: "Streamlined multimedia"
    icon: <svg style="width:65%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    ...
    details: "Request, manage, organize, and consume Movies, TV, Subtitles, Music, Books, ..."
    link: /stacks/servarr
  - title: Dashboards
    icon:  <svg style="width:65%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              <path fill="#7fc5d9" d="M13 9V3h8v6zM3 13V3h8v10zm10 8V11h8v10zM3 21v-6h8v6z" />
            </svg>
    details: "Shortcuts, bookmarks and server metrics conveniently centralized."
  ...
  - title: Batteries included
    ...
    details: "Reverse proxy, container management, and secure remote access."
    link: /stacks/core
---
